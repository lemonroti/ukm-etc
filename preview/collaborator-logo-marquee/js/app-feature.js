...
import { SiteHeader, SiteFooter, BackToTop } from '../../../js/components.js';
...
const App = {
  ...
  template: `<div class="min-h-screen bg-cream text-ink"><SiteHeader /><router-view /><SiteFooter /><BackToTop /></div>`,
};
