import { AboutPage, ResearchPage, WorkPackageDetailPage, MediaPage, MediaDetailPage, PublicationsPage, PublicationDetailPage, FaqPage, ContactPage } from '../../../js/components.js';
import { HomePageFeature } from './pages/HomePageFeature.js';

const routes = [
  { path: '/', component: HomePageFeature, meta: { title: 'Home Preview' } },
